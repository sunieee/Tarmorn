...
train = f"data/FB15k-237/train.txt"
filter_set = f"data/FB15k-237/valid.txt"
target = f"data/FB15k-237/test.txt"

rules = f"out/FB15k-237/rule-100000.txt"

ranking_file = f"out/FB15k-237/ranking.txt"
